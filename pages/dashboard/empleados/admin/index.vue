...
const adminCards = [
  ...
  { to: '/dashboard/empleados/admin/servicios',        icon: 'mdi-room-service',        color: 'orange',   title: 'Servicios',        description: 'Catálogo de servicios' },
  { to: '/dashboard/empleados/admin/pedidos',          icon: 'mdi-clipboard-list',      color: 'purple',   title: 'Pedidos',          description: 'Gestionar pedidos de servicios' },
  { to: '/dashboard/empleados/admin/reportes',         icon: 'mdi-chart-bar',           color: 'indigo',   title: 'Reportes',         description: 'Estadísticas y análisis' },
  { to: '/dashboard/empleados/admin/reset-stats',      icon: 'mdi-lock-reset',          color: 'grey',     title: 'Reset Stats',      description: 'Estadísticas de tokens' },
]
</script>
